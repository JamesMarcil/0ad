...
CRenderer::CRenderer(Renderer::Backend::IDevice* device)
{
	...
	TRACY_PLOT_CONFIG("Terrain Tris", TRACY_PLOT_TYPE_NUMBER, true, false, TRACY_COLOR_RENDER);
	TRACY_PLOT_CONFIG("Water Tris", TRACY_PLOT_TYPE_NUMBER, true, false, TRACY_COLOR_RENDER);
	TRACY_PLOT_CONFIG("Model Tris", TRACY_PLOT_TYPE_NUMBER, true, false, TRACY_COLOR_RENDER);
	TRACY_PLOT_CONFIG("Overlay Tris", TRACY_PLOT_TYPE_NUMBER, true, false, TRACY_COLOR_RENDER);
	TRACY_PLOT_CONFIG("Blend Splats", TRACY_PLOT_TYPE_NUMBER, true, false, TRACY_COLOR_RENDER);
	TRACY_PLOT_CONFIG("Particles", TRACY_PLOT_TYPE_NUMBER, true, false, TRACY_COLOR_RENDER);
	TRACY_PLOT_CONFIG("Simulation Turn (ms)", TRACY_PLOT_TYPE_NUMBER, false, false, TRACY_COLOR_SIMULATION);
	TRACY_PLOT_CONFIG("Active Entities", TRACY_PLOT_TYPE_NUMBER, true, false, TRACY_COLOR_SIMULATION);
	TRACY_PLOT_CONFIG("Path Requests Long", TRACY_PLOT_TYPE_NUMBER, true, false, TRACY_COLOR_PATHFINDING);
	TRACY_PLOT_CONFIG("Path Requests Short", TRACY_PLOT_TYPE_NUMBER, true, false, TRACY_COLOR_PATHFINDING);
	TRACY_PLOT_CONFIG("JS Heap Size", TRACY_PLOT_TYPE_MEMORY, false, false, TRACY_COLOR_SCRIPT);
	TRACY_PLOT_CONFIG("Task Queue Normal", TRACY_PLOT_TYPE_NUMBER, true, false, TRACY_COLOR_TASK);
	TRACY_PLOT_CONFIG("Task Queue Low", TRACY_PLOT_TYPE_NUMBER, true, false, TRACY_COLOR_TASK);
