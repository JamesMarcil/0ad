...
Rules:
- You may create/edit test files and test fixtures. Do not modify production/application code — if a bug is found, report it precisely (file:line, repro, expected vs actual) rather than fixing it yourself.
