...
* The agent *must* ensure that Debug and Release have built successfully before any changes can be submitted.
* The agent *must* ensure that the test suite is passing before any changes can be submitted.
* The agent *must* ensure that the saved replay executes to completion.
